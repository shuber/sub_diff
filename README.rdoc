...
For a closer look at the changes, you can enumerate thru each <tt>Diff</tt> object which also behaves like a <tt>String</tt> but includes a few additional methods: <tt>value</tt>, <tt>value_was</tt>, and <tt>changed?</tt>.
