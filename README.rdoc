...
For a closer look at the changes, you can enumerate thru the returned replacement object, yielding a <tt>Diff</tt> object for each iteration. Each <tt>Diff</tt> also behaves like a <tt>String</tt> but includes a few additional methods: <tt>value</tt>, <tt>value_was</tt>, and <tt>changed?</tt>.
